  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 p-4 pb-6 bg-gradient-to-t from-black via-black/95 to-transparent md:hidden">
        <a href="https://calendly.com/landyourweb/15min" target="_blank" rel="noopener noreferrer" className="btn-premium w-full py-4 min-h-[52px]" onClick={() => trackCTA('mobile_sticky')}>
      ...
      <main className="min-h-screen bg-black text-white overflow-x-hidden noise-overlay">
        ...
        <nav className="fixed top-0 w-full z-40 bg-black/80 backdrop-blur-2xl border-b border-white/[0.06]">
          <div className="max-w-6xl mx-auto px-6 h-[72px] flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="https://calendly.com/landyourweb/15min" target="_blank" rel="noopener noreferrer" className="btn-premium py-3 px-6 text-sm" onClick={() => trackCTA('nav')}>
        ...
        <section className="relative pt-32 pb-20 px-6 md:pt-44 md:pb-28 lg:pt-52 lg:pb-32 overflow-hidden min-h-[90vh] flex items-center">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col items-center gap-4 mb-8 animate-fade-in-up delay-300">
              <a href="https://calendly.com/landyourweb/15min" target="_blank" rel="noopener noreferrer" className="btn-premium group text-base py-4 px-10" onClick={() => trackCTA('hero')}>
        ...
        <section className="py-24 px-6 md:py-32 relative">
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <a href="https://calendly.com/landyourweb/15min" target="_blank" rel="noopener noreferrer" className="btn-premium group scroll-reveal" onClick={() => trackCTA('problem_section')}>
              <span>{primaryCTA}</span>
              <svg className="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
        ...
        <section className="py-24 px-6 md:py-32 relative">
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <div className="mt-10 text-center scroll-reveal">
              <a href="https://calendly.com/landyourweb/15min" target="_blank" rel="noopener noreferrer" className="btn-premium group" onClick={() => trackCTA('pricing')}>
                <span>{primaryCTA}</span>
                <svg className="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 mb-8">
                ...
                <a href="https://calendly.com/landyourweb/15min" target="_blank" rel="noopener noreferrer" className="text-sm text-[#71717A] hover:text-white transition-colors" onClick={() => trackCTA('footer')}>Contact</a>
              </div>
